...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="${staticServePath}/js/lib/vditor-0.2.0/index.classic.css" />
    ...
    <body onhashchange="admin.setCurByHash();">
        ...
        <script src="${staticServePath}/js/lib/vditor-0.2.0/index.min.js"></script>
