...
admin.articleList={tablePagination:new TablePaginate("article"),init:function(t){this.tablePagination.buildTable([{text:Label.titleLabel,index:"title",minWidth:110,style:"padding-left: 12px;font-size:14px;"},{text:Label.authorLabel,index:"author",width:150,style:"padding-left: 12px;"},{text:Label.commentLabel,index:"comments",width:80,style:"padding-left: 12px;"},{text:Label.viewLabel,width:60,index:"articleViewCount",style:"padding-left: 12px;"},{text:Label.dateLabel,index:"date",width:90,style:"padding-left: 12px;"}]),this.tablePagination.initPagination(),this.tablePagination.initCommentsDialog(),this.getList(t);var a=this;$("#articleListBtn").click((function(){a.getList(t)})),$("#articleListInput").keypress((function(e){13===e.keyCode&&a.getList(t)}))},syncToHacpai:function(t){$.ajax({url:Label.servePath+"/console/article/push2rhy?id="+t,type:"GET",cache:!1,success:function(t,a){$("#tipMsg").text(Label.pushSuccLabel)}})},getList:function(t){var a=this;$("#loadMsg").text(Label.loadingLabel),$.ajax({url:Label.servePath+"/console/articles/status/published/"+t+"/"+Label.PAGE_SIZE+"/"+Label.WINDOW_SIZE+"?k="+$("#articleListInput").val(),type:"GET",cache:!1,success:function(e,i){if($("#tipMsg").text(e.msg),e.sc){for(var l=e.articles,n=[],s=0;s<l.length;s++){n[s]={},n[s].title='<a href="'+Label.servePath+l[s].articlePermalink+"\" target='_blank' title='"+l[s].articleTitle+"' class='no-underline'>"+l[s].articleTitle+"</a><span class='table-tag'>"+l[s].articleTags+"</span>",n[s].date=$.bowknot.getDate(l[s].articleCreateTime),n[s].comments=`<span data-uvstatcmt="${l[s].oId}">${l[s].articleCommentCount}</span>`,n[s].articleViewCount='<span data-uvstaturl="'+Label.servePath+l[s].articlePermalink+'">'+l[s].articleViewCount+"</span>",n[s].author=l[s].authorName;var c=l[s].articlePutTop?Label.cancelPutTopLabel:Label.putTopLabel;n[s].expendRow="<a href='javascript:void(0)' onclick=\"admin.article.get('"+l[s].oId+"', true)\">"+Label.updateLabel+"</a>                                  <a href='javascript:void(0)' onclick=\"admin.article.del('"+l[s].oId+"', 'article', '"+encodeURIComponent(l[s].articleTitle)+"')\">"+Label.removeLabel+"</a>                                  <a href='javascript:void(0)' onclick=\"admin.articleList.syncToHacpai('"+l[s].oId+"')\">"+Label.pushToHacpaiLabel+"</a>                                  <a href='javascript:void(0)' onclick=\"admin.articleList.popTop(this, '"+l[s].oId+"')\">"+c+"</a>                                  <a href='javascript:void(0)' onclick=\"admin.comment.open('"+l[s].oId+"', 'article')\">"+Label.commentLabel+"</a>"}a.tablePagination.updateTablePagination(n,t,e.pagination),Util.uvstat.renderStat(),Util.uvstat.renderCmtStat(),$("#loadMsg").text("")}else $("#loadMsg").text("")}})},popTop:function(t,a){$("#loadMsg").text(Label.loadingLabel),$("#tipMsg").text("");var e=$(t),i="canceltop",l=Label.putTopLabel;e.html()===Label.putTopLabel&&(i="puttop",l=Label.cancelPutTopLabel),$.ajax({url:Label.servePath+"/console/article/"+i+"/"+a,type:"PUT",cache:!1,success:function(t,a){$("#tipMsg").text(t.msg),t.sc?(e.html(l),$("#loadMsg").text("")):$("#loadMsg").text("")}})}},admin.register["article-list"]={obj:admin.articleList,init:admin.articleList.init,refresh:admin.articleList.getList};
admin.draftList={tablePagination:new TablePaginate("draft"),init:function(t){this.tablePagination.buildTable([{text:Label.titleLabel,index:"title",minWidth:110,style:"padding-left: 12px;font-size:14px;"},{text:Label.authorLabel,index:"author",width:150,style:"padding-left: 12px;"},{text:Label.commentLabel,index:"comments",width:80,style:"padding-left: 12px;"},{text:Label.viewLabel,width:60,index:"articleViewCount",style:"padding-left: 12px;"},{text:Label.dateLabel,index:"date",width:90,style:"padding-left: 12px;"}]),this.tablePagination.initPagination(),this.tablePagination.initCommentsDialog(),this.getList(t)},getList:function(t){$("#loadMsg").text(Label.loadingLabel);var a=this;$.ajax({url:Label.servePath+"/console/articles/status/unpublished/"+t+"/"+Label.PAGE_SIZE+"/"+Label.WINDOW_SIZE,type:"GET",cache:!1,success:function(e,i){if($("#tipMsg").text(e.msg),e.sc){for(var l=e.articles,n=[],s=0;s<l.length;s++)n[s]={},n[s].tags=l[s].articleTags,n[s].date=$.bowknot.getDate(l[s].articleCreateTime),n[s].comments=`<span data-uvstatcmt="${l[s].oId}">${l[s].articleCommentCount}</span>`,n[s].articleViewCount='<span data-uvstaturl="'+Label.servePath+l[s].articlePermalink+'">'+l[s].articleViewCount+"</span>",n[s].author=l[s].authorName,n[s].title="<a class='no-underline' href='"+Label.servePath+l[s].articlePermalink+"' target='_blank'>"+l[s].articleTitle+"</a><span class='table-tag'>"+l[s].articleTags+"</span>",n[s].expendRow="<a href='javascript:void(0)' onclick=\"admin.article.get('"+l[s].oId+"', false);\">"+Label.updateLabel+"</a>                                  <a href='javascript:void(0)' onclick=\"admin.article.del('"+l[s].oId+"', 'draft', '"+encodeURIComponent(l[s].articleTitle)+"')\">"+Label.removeLabel+"</a>                                  <a href='javascript:void(0)' onclick=\"admin.comment.open('"+l[s].oId+"', 'draft')\">"+Label.commentLabel+"</a>";a.tablePagination.updateTablePagination(n,t,e.pagination),Util.uvstat.renderStat(),Util.uvstat.renderCmtStat(),$("#loadMsg").text("")}else $("#loadMsg").text("")}})}},admin.register["draft-list"]={obj:admin.draftList,init:admin.draftList.init,refresh:admin.draftList.getList};
